...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="bg-zinc-50">
            <div className="container text-center lg:text-left lg:flex lg:justify-between ">
                <div className="lg:w-1/2 xl:py-14 lg:py-8">
                    <p className="tracking-widest">OFFER FOR THE BEST INTERIOR</p>
                    <h1 className="py-4 text-3xl font-extrabold leading-tight text-gray-800 xl:text-7xl lg:text-4xl">An aesthetic room is <br />given harmony</h1>
                    <p className="text-gray-500 xl:pb-10 lg:pb-6">
                ...
                <div className="w-1/2">
                    <Image src="/image/kitchen.png" width={800} height={500} alt="" className="absolute right-0 xl:h-[488px] xl:w-[700px] lg:h-[344px] lg:w-[500px]  hidden lg:block" />
                </div>
