    ...
    return (
        <div>
            <div className="bg-[url('/image/about.jpg')] bg-center bg-cover ">
                <h1 className="container py-64 text-6xl font-semibold tracking-widest text-white ">WHO ARE WE ?</h1>

            </div>
            <div className="container ">
                <div className="py-14">
                    <h2 className="p-20 text-5xl font-semibold text-center">We have great idea & Interior Design</h2>
                    <p className="w-1/2 text-2xl font-medium">
